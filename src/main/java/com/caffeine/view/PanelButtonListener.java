...
public class PanelButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (button.getText().equals("Change Color")) {
            ...
            switch(playerColor) {
                ...
                case 0: 
                    Color newColor = JColorChooser.showDialog(window,
                            ...
                            Color.BLACK);
                    statusLabel.setText("[Upcoming Feature] - Changed color of Black");
                ...
                case 1: 
                    newColor = JColorChooser.showDialog(window,
                            "Choose Color for Polygon",
                            Color.WHITE);
                    statusLabel.setText("[Upcoming Feature] - Changed color of White");
                    for (int i = 0; i < 8; i++) {   // iterate through all rows and columns of board
                        for (int j = 0; j < 8; j++) {
